...
a persistence unit "ups.edu.ec.ArmijosFabian.OperadoraJEEPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ups.edu.ec.ArmijosFabian.OperadoraJEE\pom.xml":
...
artifact ("ups.edu.ec.ArmijosFabian.OperadoraJEE.war") is already built. You can build
